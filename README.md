OCR.py: a program that takes a sudoku grid, isolates each box, and using a dataset containing 10,000 samples of hand-drawn numbers, determines the digit inside each box
